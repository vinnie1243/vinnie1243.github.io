async function gen(piece, pos, color, aiValidate) { 
    ...
    switch (text2) {
        case "pawn":
            ...
            var pawnMove3   
            if(s == "white" && color == "white" && ptchckR(pos, color, s) == true && p8 != 0) {
                var npos = pos - 7
                pawnMove3 = [npos, color, s, "red", "pawn", "pawnMove3", pos, "t"]
                arr.push(pawnMove3)
            } else if(s == "white" && color == "black" && ptchckR(pos, color, s) == true && p8 != 0) {
                var npos = pos + 9
                pawnMove3 = [npos, color, s, "red", "pawn", "pawnMove3", pos, "t"]
                arr.push(pawnMove3)
            } else if(s == "black" && color == "white" && ptchckR(pos, color, s) == true && p8 != 0) {
                var npos = pos + 9
                pawnMove3 = [npos, color, s, "red", "pawn", "pawnMove3", pos, "t"] 
                arr.push(pawnMove3)
            } else if(s == "black" && color == "black" && ptchckR(pos, color, s) == true && p8 != 0) {
                var npos = pos - 7
                pawnMove3 = [npos, color, s, "red", "pawn", "pawnMove3", pos, "t"]
                arr.push(pawnMove3)
            }
        ...
        case "queen":
            ...
            if(s == "white" && color == "white" && ((pos - 16) - 2) < 65 && ((pos - 16) - 2) > 0 && p8 != 1 && p8 != 2) {
                var npos = (pos - 16) - 2
                queenMove51 = [npos, color, s, takec(npos, color), "queen", "queenMove51", pos, "t", ig(pos)]
    ...
    var arr3 = isValid(arr, aiValidate)
    if(aiValidate == false) {
        draw(arr3, arr)
    }
...
function isValid(arr, aiValidate) {
    window.sessionStorage.setItem("arr2", JSON.stringify(arr))
    var arr2 = []
    var arr3 = []
    for(var j = 0; j < arr.length; j++) {
        ...
        var c1 = cmove(pos, npos, move, type, color, sw, aiValidate)
        //console.log(c1)
        if(c1 == "") {
...
function draw(arr, arr2) {
    ...
    for(var i = 0; i < arr.length; i++) {
        ...
        if(arr2[i][1] == arr2[i][2] || local == "true") {
            if(take == "green") {
    ...
    if(arr.length != arr2.length) {
        window.alert(`error array lengths dont match arr: ${arr.length} arr2: ${arr2.length} check console`)
        console.log("error array lengths dont match", arr2)
    }
}
...
function cmove(pos, npos, move, type, color, sw, aiMode) {
    var arr = []
    switch(type) {
        case "pawn":
            if(move == "pawnMove1") {
                if(sw == "white" && color == "white") {
                    ...
                    var sq = document.getElementById(pos - 8)
                    if(sq.children.length == 1) {
                        //piece is in the way dont push to arr becuase pawn cant take forward
                    } else {
                        //no piece is blocking 
                        arr.push(npos)
                    }
